...
concrete adapter (Anthropic, added later) translates them to and from a real
API. A FakeLLM implements the same interface so the loop can be tested
deterministically, with no API key, cost, or network.
"""
